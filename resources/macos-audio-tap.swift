...
final class AudioTapCapture {
    ...
    private let ioQueue = DispatchQueue(label: "com.ektoswhispr.audio-tap")
    ...
    func start() throws {
        ...
        tapDescription.name = "ektoswhispr-audio-tap"
    ...
    private func createAggregateDevice(tapUID: String) throws {
        let description: [String: Any] = [
            kAudioAggregateDeviceNameKey: "EktosWhispr Audio Tap",
            kAudioAggregateDeviceUIDKey: "com.ektoswhispr.audio-tap.\(UUID().uuidString)",
...
func makeError(
    ...
    return NSError(domain: "EktosWhisprAudioTap", code: Int(status ?? -1), userInfo: userInfo)
}
