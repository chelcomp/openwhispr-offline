#!/usr/bin/env node
// Compiles src/assets/ektoswhispr.icon (Apple Icon Composer bundle) into
...
const ICON_BUNDLE = path.join(__dirname, "..", "src", "assets", "ektoswhispr.icon");
const OUTPUT_CAR = path.join(__dirname, "..", "src", "assets", "Assets.car");
const APP_ICON_NAME = "ektoswhispr";
