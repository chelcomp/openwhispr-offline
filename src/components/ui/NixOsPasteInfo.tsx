...
inputs.ektoswhispr.url = "github:EktosWhispr/ektoswhispr";

# in your NixOS modules
imports = [ ektoswhispr.nixosModules.default ];
      ...
      <div className="space-y-2">
        ...
        <p className="text-xs text-muted-foreground">
          {t("settingsPage.general.waylandPaste.nixos.flakeDesc", {
            defaultValue:
              "If you install EktosWhispr from the flake, programs.ektoswhispr.enable turns on ydotool, the uinput module and the group memberships for you.",
          })}
        </p>
