...
try {
  ...
  const userDataPath =
    process.platform === "darwin"
      ? path.join(os.homedir(), "Library", "Application Support", "ektos-whispr")
      : process.platform === "win32"
        ? path.join(process.env.APPDATA || os.homedir(), "ektos-whispr")
        : path.join(os.homedir(), ".config", "ektos-whispr");
